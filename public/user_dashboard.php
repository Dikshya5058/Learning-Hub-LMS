...
// 2. ONLY fetch the current user's active wishlist items
// This ensures we only care about what the logged-in user is doing
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .text-avail { color: #10b981; }      /* Green for everyone else */
        .text-wishlist { color: #ef4444; }   /* Red for YOURS */
    ...
    <main class="main-content">
        ...
        <section class="book-shelf">
            <?php foreach($books as $book): 
                $book_id = $book['id'];
                $on_my_wishlist = in_array($book_id, $my_wishlist);
            ?>
            <div class="book-card">
                <div class="card-header">
                    <div class="badge-container">
                        ...
                        <span class="status-text <?php echo $on_my_wishlist ? 'text-wishlist' : 'text-avail'; ?>">
                            <?php echo $on_my_wishlist ? 'In Wishlist' : 'Available'; ?>
                        </span>
                    </div>
